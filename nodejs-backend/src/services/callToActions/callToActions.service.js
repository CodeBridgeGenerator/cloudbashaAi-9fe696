const { CallToActions } = require("./callToActions.class");
const createModel = require("../../models/callToActions.model");
const hooks = require("./callToActions.hooks");
...
module.exports = function (app) {
  ...
  app.use("/callToActions", new CallToActions(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("callToActions");

  // Get the schema of the collections 
  app.get("/callToActionsSchema", function (request, response) {
