const { ContactSubmissions } = require("./contactSubmissions.class");
const createModel = require("../../models/contactSubmissions.model");
const hooks = require("./contactSubmissions.hooks");
...
module.exports = function (app) {
  ...
  app.use("/contactSubmissions", new ContactSubmissions(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("contactSubmissions");

  // Get the schema of the collections 
  app.get("/contactSubmissionsSchema", function (request, response) {
