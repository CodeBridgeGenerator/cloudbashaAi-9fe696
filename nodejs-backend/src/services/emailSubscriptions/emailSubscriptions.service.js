const { EmailSubscriptions } = require("./emailSubscriptions.class");
const createModel = require("./emailSubscriptions.model");
const hooks = require("./emailSubscriptions.hooks");
...
module.exports = function (app) {
  ...
  app.use("/emailSubscriptions", new EmailSubscriptions(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("emailSubscriptions");

  // Get the schema of the collections 
  app.get("/emailSubscriptionsSchema", function (request, response) {
