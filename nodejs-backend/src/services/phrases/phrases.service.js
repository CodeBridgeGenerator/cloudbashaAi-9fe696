const { Phrases } = require("./phrases.class");
const createModel = require("../../models/phrases.model");
const hooks = require("./phrases.hooks");
...
module.exports = function (app) {
  ...
  app.use("/phrases", new Phrases(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("phrases");

  // Get the schema of the collections 
  app.get("/phrasesSchema", function (request, response) {
