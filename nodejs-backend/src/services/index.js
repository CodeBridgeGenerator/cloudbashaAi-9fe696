...
const featureRequests = require("./featureRequests/featureRequests.service.js");
const careers = require("./careers/careers.service.js");
const emailSubscriptions = require("./emailSubscriptions/emailSubscriptions.service.js");
...
module.exports = function (app) {
  ...
  app.configure(featureRequests);
  app.configure(careers);
  app.configure(emailSubscriptions);
