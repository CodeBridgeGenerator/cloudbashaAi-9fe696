const { FormGenerator } = require("./formGenerator.class");
const createModel = require("../../models/formGenerator.model");
const hooks = require("./formGenerator.hooks");
...
module.exports = function (app) {
  ...
  app.use("/formGenerator", new FormGenerator(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("formGenerator");

  // Get the schema of the collections 
  app.get("/formGeneratorSchema", function (request, response) {
