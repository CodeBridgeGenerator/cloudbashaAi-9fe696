const { ApiTokens } = require("./apiTokens.class");
const createModel = require("../../models/apiTokens.model");
const hooks = require("./apiTokens.hooks");
...
module.exports = function (app) {
  ...
  app.use("/apiTokens", new ApiTokens(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("apiTokens");

  // Get the schema of the collections 
  app.get("/apiTokensSchema", function (request, response) {
