const { Bonus } = require("./bonus.class");
const createModel = require("../../models/bonus.model");
const hooks = require("./bonus.hooks");
...
module.exports = function (app) {
  ...
  app.use("/bonus", new Bonus(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("bonus");

  // Get the schema of the collections 
  app.get("/bonusSchema", function (request, response) {
