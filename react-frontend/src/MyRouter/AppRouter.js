...
import SingleFeatureRequestsPage from "../components/app_components/FeatureRequestsPage/SingleFeatureRequestsPage";
import FeatureRequestProjectLayoutPage from "../components/app_components/FeatureRequestsPage/FeatureRequestProjectLayoutPage";
import SingleCareersPage from "../components/app_components/CareersPage/SingleCareersPage";
import CareerProjectLayoutPage from "../components/app_components/CareersPage/CareerProjectLayoutPage";
import SingleEmailSubscriptionsPage from "../components/app_components/EmailSubscriptionsPage/SingleEmailSubscriptionsPage";
import EmailSubscriptionProjectLayoutPage from "../components/app_components/EmailSubscriptionsPage/EmailSubscriptionProjectLayoutPage";
//  ~cb-add-import~
...
<Route path="/featureRequests/:singleFeatureRequestsId" exact element={<SingleFeatureRequestsPage />} />
<Route path="/featureRequests" exact element={<FeatureRequestProjectLayoutPage />} />
<Route path="/careers/:singleCareersId" exact element={<SingleCareersPage />} />
<Route path="/careers" exact element={<CareerProjectLayoutPage />} />
<Route path="/emailSubscriptions/:singleEmailSubscriptionsId" exact element={<SingleEmailSubscriptionsPage />} />
<Route path="/emailSubscriptions" exact element={<EmailSubscriptionProjectLayoutPage />} />
