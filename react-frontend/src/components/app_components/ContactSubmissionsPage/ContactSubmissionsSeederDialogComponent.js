...
import seederData from "./contactSubmissions.seeder.json";
...
const ContactSubmissionsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ContactSubmissionsSeederDialogComponent);
