...
import seederData from "./formGenerator.seeder.json";
...
const FormGeneratorSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FormGeneratorSeederDialogComponent);
