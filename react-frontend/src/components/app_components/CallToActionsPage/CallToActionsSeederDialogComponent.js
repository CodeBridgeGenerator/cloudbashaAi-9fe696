...
import seederData from "./callToActions.seeder.json";
...
const CallToActionsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CallToActionsSeederDialogComponent);
