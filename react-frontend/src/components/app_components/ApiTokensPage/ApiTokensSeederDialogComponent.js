...
import seederData from "./apiTokens.seeder.json";
...
const ApiTokensSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ApiTokensSeederDialogComponent);
