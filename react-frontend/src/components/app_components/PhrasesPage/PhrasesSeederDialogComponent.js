...
import seederData from "./phrases.seeder.json";
...
const PhrasesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PhrasesSeederDialogComponent);
