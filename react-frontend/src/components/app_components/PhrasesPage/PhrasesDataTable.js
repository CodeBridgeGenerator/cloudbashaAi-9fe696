...
const PhrasesDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.tagline}</p>
const p_booleanTemplate3 = (rowData, { rowIndex }) => <p >{String(rowData.visible)}</p>
...
<Column field="tagline" header="Tagline" body={pTemplate2} filter={selectedFilterFields.includes("tagline")} hidden={selectedHideFields?.includes("tagline")}  sortable style={{ minWidth: "8rem" }} />
<Column field="visible" header="Visible" body={p_booleanTemplate3} filter={selectedFilterFields.includes("visible")} hidden={selectedHideFields?.includes("visible")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Phrases Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
          serviceName="phrases"            
          onUploadComplete={() => {
      ...
      <Dialog header="Search Phrases" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default PhrasesDataTable;