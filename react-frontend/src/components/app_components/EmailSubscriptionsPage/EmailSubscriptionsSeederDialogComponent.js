...
import seederData from "./emailSubscriptions.seeder.json";
...
const EmailSubscriptionsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EmailSubscriptionsSeederDialogComponent);
