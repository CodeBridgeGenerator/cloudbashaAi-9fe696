...
import seederData from "./headers.seeder.json";
...
const HeadersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(HeadersSeederDialogComponent);
