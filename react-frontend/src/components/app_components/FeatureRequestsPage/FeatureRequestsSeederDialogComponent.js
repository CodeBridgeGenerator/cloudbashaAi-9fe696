...
import seederData from "./featureRequests.seeder.json";
...
const FeatureRequestsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FeatureRequestsSeederDialogComponent);
