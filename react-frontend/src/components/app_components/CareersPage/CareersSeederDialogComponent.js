...
import seederData from "./careers.seeder.json";
...
const CareersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CareersSeederDialogComponent);
