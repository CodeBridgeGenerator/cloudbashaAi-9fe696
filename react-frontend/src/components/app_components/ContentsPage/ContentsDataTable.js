...
const ContentsDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const p_numberTemplate0 = (rowData, { rowIndex }) => <p >{rowData.step}</p>
...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="step" header="Step" body={p_numberTemplate0} filter={selectedFilterFields.includes("step")} hidden={selectedHideFields?.includes("step")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="description" header="Description" body={pTemplate2} filter={selectedFilterFields.includes("description")} hidden={selectedHideFields?.includes("description")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Contents Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search Contents" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default ContentsDataTable;