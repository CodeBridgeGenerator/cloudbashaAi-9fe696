...
import seederData from "./contents.seeder.json";
...
const ContentsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ContentsSeederDialogComponent);
