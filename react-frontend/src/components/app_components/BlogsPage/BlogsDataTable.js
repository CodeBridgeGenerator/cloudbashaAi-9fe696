...
const BlogsDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const p_numberTemplate1 = (rowData, { rowIndex }) => <p >{rowData.postedOn}</p>
...
<Column field="postedOn" header="Posted On" body={p_numberTemplate1} filter={selectedFilterFields.includes("postedOn")} hidden={selectedHideFields?.includes("postedOn")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="image2" header="image2" body={pTemplate4} filter={selectedFilterFields.includes("image2")} hidden={selectedHideFields?.includes("image2")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Blogs Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
          serviceName="blogs"            
          onUploadComplete={() => {
      ...
      <Dialog header="Search Blogs" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
