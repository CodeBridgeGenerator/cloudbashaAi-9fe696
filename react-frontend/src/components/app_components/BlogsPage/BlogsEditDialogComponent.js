...
const BlogsEditDialogComponent = (props) => {
...
image2: _entity?.image2,
        ...
        const result = await client.service("blogs").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info blogs updated successfully" });
    ...
    return (
        <Dialog header="Edit Blogs" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="blogs-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="postedOn" className="w-full mb-3 p-inputtext-sm" value={_entity?.postedOn} onChange={(e) => setValByKey("postedOn", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(BlogsEditDialogComponent);
