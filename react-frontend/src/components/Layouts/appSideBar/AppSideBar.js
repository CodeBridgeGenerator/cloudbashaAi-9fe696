                ...
                },
{
                  ...
                  menuKey: "formGenerator",
                  to: "/app/formGenerator",
                },
{
                  icon: <Home />,
                  label: "Contact Submissions",
                  menuKey: "contactSubmissions",
                  to: "/app/contactSubmissions",
                },
{
                  icon: <Home />,
                  label: "Payments",
                ...
                },
{
                  ...
                  menuKey: "callToActions",
                  to: "/app/callToActions",
                },
{
                  icon: <Home />,
                  label: "Api Tokens",
                ...
                },
{
                  ...
                  menuKey: "featureRequests",
                  to: "/app/featureRequests",
                },
{
                  icon: <Home />,
                  label: "Careers",
...
{
                  icon: <Home />,
                  label: "EmailSubscriptions",
                  menuKey: "emailSubscriptions",
                  to: "/app/emailSubscriptions",
                },
                /* ~cb-add-menu~ */
              ]}
            />
